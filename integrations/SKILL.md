...
description: >
  ...
  heartbeat from a cron job, or mentions Sonde, downtime, or a status page.
---
...
This CLI reads all of that and pushes heartbeats, without the dashboard.

## When to apply

Use when the user asks whether something is up or down, how much downtime
there was, what broke and when, or wants a cron job to report in.
Triggers: "is it up", "down", "downtime", "uptime", "monitor", "incident",
"status page", "heartbeat", "sonde", "did it go down"
